...
namespace WebApplication1.DataSet1TableAdapters {
    ...
    public partial class ProyectoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[1].CommandText = "INSERT INTO [dbo].[Proyecto] ([IdProyecto], [Nombre], [Objetivo(s)], [Estado], [F" +
                "echaIni], [FechaFin], [FechaAsig]) VALUES (@IdProyecto, @Nombre, @p1, @Estado, @" +
                "FechaIni, @FechaFin, @FechaAsig)";
            ...
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@FechaIni", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "FechaIni", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@FechaFin", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "FechaFin", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
            this._commandCollection[1].Parameters.Add(new global::System.Data.SqlClient.SqlParameter("@FechaAsig", global::System.Data.SqlDbType.Date, 3, global::System.Data.ParameterDirection.Input, 0, 0, "FechaAsig", global::System.Data.DataRowVersion.Current, false, null, "", "", ""));
        }
        ...
        public virtual int InsertarDatos(int IdProyecto, string Nombre, string p1, string Estado, string FechaIni, string FechaFin, string FechaAsig) {
            ...
            if ((FechaIni == null)) {
                ...
                command.Parameters[4].Value = ((string)(FechaIni));
            }
            if ((FechaFin == null)) {
                command.Parameters[5].Value = global::System.DBNull.Value;
            }
            else {
                command.Parameters[5].Value = ((string)(FechaFin));
            }
            if ((FechaAsig == null)) {
                throw new global::System.ArgumentNullException("FechaAsig");
            }
            else {
                command.Parameters[6].Value = ((string)(FechaAsig));
            }
